    ...
    >
      <div class="content-wrapper">
        ...
        <aside class="sidebar-column">
          <RelatedArticles :current-article="article" />
        </aside>
      </div>
    </div>
  </div>
...
import RelatedArticles from '@/components/public/RelatedArticles.vue';

const route = useRoute();
const settingsStore = useSettingsStore();
const { theme } = useTheme('public-theme');
...
const iframeStyles = `
  :root {
    ...
    --color-functional-element: #000000;
    --color-secondary-structure: #888888;
    --font-family-serif: 'Montserrat', sans-serif;
    --font-family-sans-serif: 'Montserrat', sans-serif;
    --font-family-artistic: 'Pinyon Script', cursive;
  }
  html.dark {
    --color-main-bg: #111111;
    --color-primary-text: #CCCCCC;
    --color-functional-element: #FFFFFF;
    --color-secondary-structure: #888888;
  }
  body, html {
    margin: 0;
  ...
  blockquote {
    border-left: 3px solid var(--color-functional-element);
    margin: 0;
    padding-left: 16px;
    font-style: italic;
...
const iframeContent = computed(() => {
  ...
  return `
    ...
    <head>
      ...
      <!-- Attempt to load fonts if possibly cached or allowed -->
      <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;700&family=Montserrat:wght@300;400;600&family=Pinyon+Script&display=swap" rel="stylesheet">
    </head>
    <body>
...
onMounted(() => {
  fetchArticleDetails(route.params.id);
});
