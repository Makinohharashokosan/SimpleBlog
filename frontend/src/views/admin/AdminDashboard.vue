<template>
  <div class="dashboard-container">
    <!-- 1. 欢迎横幅 -->
    <header
      v-if="settings.authorName"
      class="welcome-banner"
    >
      <h1 class="welcome-title">
        <span class="greeting">{{ $t('admin.dashboard.welcome') }}</span>
    ...
    <section class="stats-grid">
      ...
      >
        ...
        <div class="stat-decorative-line" />
      </div>
    </section>
    ...
    <section class="quick-actions">
      ...
      <div class="actions-wrapper">
        ...
        >
          ...
          {{ $t('admin.dashboard.quick_actions.create_article') }}
        </button>
        <button
        ...
        >
          <span class="icon">⚙</span>
          {{ $t('admin.dashboard.quick_actions.settings') }}
        </button>
      </div>
    </section>
  </div>
...
const statsCards = computed(() => [
  { label: t('admin.dashboard.stats.articles'), value: statsData.value.totalArticles },
  { label: t('admin.dashboard.stats.views'), value: statsData.value.totalViews.toLocaleString() },
  { label: t('admin.dashboard.stats.tags'), value: statsData.value.totalTags }
]);
...
onMounted(async () => {
  ...
  try {
    ...
    /* eslint-disable */console.error(...oo_tx(`3529509548_86_4_86_59_11`,"Failed to load dashboard stats:", error));
  }
});
