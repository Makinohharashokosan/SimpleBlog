  ...
  <div class="settings-page">
    ...
    >
      ...
      >
        <div class="section-header">
          <h2 class="section-title">
            {{ $t('admin.settings.sections.author') }}
          </h2>
          <div class="section-line" />
        </div>
      ...
      >
        <div class="section-header">
          <h2 class="section-title">
            {{ $t('admin.settings.sections.social') }}
          </h2>
          <div class="section-line" />
        </div>
      ...
      >
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <label class="form-label">{{ $t('admin.settings.security.new_username') }}</label>
            <BaseInput
          ...
          <div class="form-group">
            <label class="form-label">{{ $t('admin.settings.security.current_password') }}</label>
            <BaseInput
          ...
          >
            ...
            >
              {{ isUpdatingUsername ? $t('common.loading') : $t('admin.settings.security.update_username_btn') }}
            </button>
            <span
              v-if="usernameMessage"
              :class="{ 'error-text': isUsernameError, 'success-text': !isUsernameError }"
            >
              {{ usernameMessage }}
            </span>
          </div>
          ...
          <div class="form-group span-full">
            ...
            >
              {{ $t('admin.settings.security.save_btn') }}
            </h3>
          </div>
          <div class="form-group span-full">
            <label class="form-label">{{ $t('admin.settings.security.old_password') }}</label>
            <BaseInput
          ...
          <div class="form-group">
            <label class="form-label">{{ $t('admin.settings.security.new_password') }}</label>
            <BaseInput
          ...
          <div class="form-group">
            <label class="form-label">{{ $t('admin.settings.security.confirm_password') }}</label>
            <BaseInput
          ...
          >
            ...
            >
              {{ isUpdatingPassword ? $t('common.loading') : $t('admin.settings.security.save_btn') }}
            </button>
            <span
              v-if="passwordMessage"
              :class="{ 'error-text': isPasswordError, 'success-text': !isPasswordError }"
            >
              {{ passwordMessage }}
            </span>
          </div>
...
const saveSettings = async () => {
  ...
  try {
    ...
    /* eslint-disable */console.error(...oo_tx(`3618481901_247_4_247_52_11`,"Failed to save settings:", error));
...
const handlePasswordUpdate = async () => {
  ...
  if (securityForm.value.newPassword !== securityForm.value.confirmPassword) {
    passwordMessage.value = t('admin.settings.security.error_mismatch');
  ...
  try {
    ...
    passwordMessage.value = t('admin.settings.security.success');
    // Clear form
    securityForm.value = { oldPassword: '', newPassword: '', confirmPassword: '' };
  } catch (error) {
    /* eslint-disable */console.error(...oo_tx(`3618481901_280_4_280_24_11`,error));
...
const handleUsernameUpdate = async () => {
  ...
  if (!usernameForm.value.newUsername || !usernameForm.value.password) {
      usernameMessage.value = 'Please fill in all fields';
  ...
  try {
    ...
    usernameMessage.value = t('admin.settings.security.username_success');
